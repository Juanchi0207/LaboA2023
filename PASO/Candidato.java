...
public class Candidato extends Persona {
     ...
     public Candidato(String nombre, String apellido, LocalDate fecha_nacimiento, HashSet<String> listaPropuestas, HashMap<Provincia, Integer> cantidadVotos) {
          super(nombre, apellido, fecha_nacimiento);
          ListaPropuestas = listaPropuestas;
          this.cantidadVotos = cantidadVotos;
     }

     public Candidato(String nombre, String apellido, int numeroTelefono, HashSet<String> listaPropuestas, HashMap<Provincia, Integer> cantidadVotos) {
          super(nombre, apellido, numeroTelefono);
          ListaPropuestas = listaPropuestas;
          this.cantidadVotos = cantidadVotos;
     }

     public Candidato(String nombre, String apellido, HashSet<String> listaPropuestas, HashMap<Provincia, Integer> cantidadVotos) {
